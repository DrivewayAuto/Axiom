"""Full OBD-II code reference (3000+ codes) from the Dipstick knowledge base.
Source: github.com/mytrile/obd-trouble-codes (cleaned). Definitions only -
the enriched diagnostic intelligence lives in enriched_codes.py.
"""
